...
Object.defineProperty(List.prototype, 'defaultListColumns', {
	get: function() {
		if (!this._defaultListColumns) {
			this._defaultListColumns = this.expandColumns(this.get('defaultListColumns'));
		}
		return this._defaultListColumns;
	}, set: function(value) {
		this.set('defaultListColumns', value);
		delete this._defaultListColumns;
	}
});
...
List.prototype.groupParent = require('./list/groupParent');
