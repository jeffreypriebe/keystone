...
function routes(app) {
	...
	function userHandler (req, res, next) {
		if 	(req.params.list === 'users' && (!req.user || !req.user._doc || !req.user._doc.isUserAdmin))
	...
	app.all('/keystone/:list/:page([0-9]{1,5})?', userHandler, initList(true), require('../../admin/routes/views/list'));
	app.all('/keystone/:list/:item', userHandler, initList(true), require('../../admin/routes/views/item'));
